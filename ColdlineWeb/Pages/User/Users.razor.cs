...
namespace ColdlineWeb.Pages.User
{
    public partial class Users : ComponentBase
    {
        ...
        // Lista de usuários que vem do PagedResult
        private List<UserModel> users = new();

        // Dados de referência para dropdown
        private List<ReferenceEntity> userTypes = new();
        // Aqui permanecemos com ReferenceEntity para o departamento, pois no UserModel o departamento é uma referência.
